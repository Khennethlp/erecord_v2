        ...
        <form action="" method="POST" id="login_form">
          ...
          <!-- /.col -->
            ...
            <div class="col-md-12">
              ...
              <div class="col-md-6">
                <a href="index.php" class="btn btn-danger btn-block">Viewer Table</a>
              </div>
              <div class="col-md-6">
                <a href="template/erecord_work_instructions.pdf" class="btn btn-success btn-block" target="_blank">Work Instruction</a>
              </div>
            </div>
          </div>
          <!-- /.col -->
