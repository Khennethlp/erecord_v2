    ...
    <div class="col-md-12">
      <div class="card card-light" style="background: #fff; border-top: 2px solid #1e96fc;">
        <div class="card-header">
          <h3 class="card-title"><img src="../../dist/img/cancelled.png" style="height:28px;">&ensp;Cancellation Request Table</h3>
        </div>
          ...
          <div class="tab-content" id="custom-tabs-one-tabContent">
            <div class="tab-pane fade active show" id="custom-tabs-one-profile" role="tabpanel" aria-labelledby="custom-tabs-one-profile-tab">
              <div class="row mt-2">
                <div class="col-sm-1">
                  <!-- approve button -->
                  <button class="btn btn-block form-control  d-flex justify-content-left" data-toggle="modal" data-target="#qc_i_approve" style="color:#fff;height:34px;border-radius:.25rem;background: #28a745;font-size:15px;font-weight:normal; padding: 5px 3px;"><img src="../../dist/img/check (1).png" style="height:19px;">&nbsp;&nbsp;Approve</button>
                </div>
