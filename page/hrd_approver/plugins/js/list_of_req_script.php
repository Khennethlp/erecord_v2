<script type="text/javascript">
  ...
  const search_history = current_page => {
    ...
    var approved_date_f = document.getElementById('approved_date_f').value;
    var approved_date_t = document.getElementById('approved_date_t').value;
    var category = document.getElementById('categoryyy').value;
    var processName_h = document.getElementById('processName_h').value;
