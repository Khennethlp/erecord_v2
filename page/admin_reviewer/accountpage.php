                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <!-- add account button -->
                            <label for="">&nbsp;</label>
                            <a class="btn btn-block d-flex justify-content-left" data-toggle="modal" data-target="#addadmin_r" style="color:#000;height:34px;border-radius:.25rem;background: #F29A35;font-size:15px;font-weight:normal;"><img src="../../dist/img/add-user.png" style="height:19px;">&nbsp;&nbsp;Add Account</a>
