  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content" style="background:#fff;">
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-sm-3">
            ...
            <input type="text" id="role_approver" class="form-control pl-3" autocomplete="off" value="<?= htmlspecialchars($_SESSION['role']); ?>" style=" color: #525252;font-size: 15px;border-radius: .25rem;border: 1px solid #525252;background: #e5e5e5;height:34px; width:100%;" >
          </div>
        <div class="col-sm-3">
          <!-- password -->
      ...
      <div class="modal-footer" style="background:#fff;">
        ...
        <div class="col-sm-3">
          <button class="btn btn-block" onclick="save_acc_approver()" style="color:#fff;height:34px;border-radius:.25rem;background: #275DAD;font-size:15px;font-weight:normal;">Add Account</button>
        </div>
      </div>
      <!-- end -->
    </div>
